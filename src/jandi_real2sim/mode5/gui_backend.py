...
EDITABLE_FIELDS = {
    ...
    "hardware": {
        ...
        "timing.telemetry_target_rate_hz", "timing.delay_telemetry_target_rate_hz",
        "timing.hardware_error_poll_rate_hz",
    },
    "safety": {
...
def completed_run_summary(path: Path, cfg: CanonicalCampaign) -> dict[str, Any]:
    ...
    summary: dict[str, Any] = {
        ...
        "measured_command_rate_hz": metadata.get("measured_command_rate_hz"),
